...
df_from_sql_sheet2=pd.read_sql('SELECT * FROM sheet2',con=connection)
...
df_new_sheet2=df_new_sheet2.dropna()
print(df_new_sheet2)

#Writing to SQL

df_new_sheet1.to_sql('sheet1',con=connection,if_exists='append',index=False)
df_new_sheet2.to_sql('sheet2',con=connection,if_exists='append',index=False)
